//
//  VoiceRegistrationViewProperties.h
//  didm_auth_sdk_iOS
//
...
@interface VoiceRegistrationViewProperties : NSObject
...
@property (nonatomic) NSString *SERVER_RESPONSE_CODE_1014;
...
@property (nonatomic) NSString *MICROPHONE_PERMISSION_REQUEST;
